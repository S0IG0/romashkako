...
INSERT INTO sale (name, count, cost, product_id, created_at, updated_at)
VALUES ('Sale 0', 10, 0.00, 1, NOW(), NOW()),
       ('Sale 1', 10, 1.00, 2, NOW(), NOW()),
       ('Sale 2', 10, 2.00, 3, NOW(), NOW()),
       ('Sale 3', 10, 3.00, 4, NOW(), NOW()),
       ('Sale 4', 10, 4.00, 5, NOW(), NOW()),
       ('Sale 5', 10, 5.00, 6, NOW(), NOW()),
       ('Sale 6', 10, 6.00, 7, NOW(), NOW()),
       ('Sale 7', 10, 7.00, 8, NOW(), NOW()),
       ('Sale 8', 10, 8.00, 9, NOW(), NOW()),
       ('Sale 9', 10, 9.00, 10, NOW(), NOW());
